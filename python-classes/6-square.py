...
and `position`, getters and setters for both attributes, a method to
calculate the area, and a method to print the square using the `#` character.
"""
...
class Square:
    ...
    def my_print(self):
        ...
        Use the position attribute to offset the square when printing.
        """
        if self.__size == 0:
            print()
        else:
